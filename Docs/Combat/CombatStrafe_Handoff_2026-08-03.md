...
1. `Docs/Animation/Locomotion/GASP_ProjectJ_Locomotion_Parity.md` — 현재 GASP 대 Project_J 정책과
   chooser 계약의 기준 문서.
2. 이 문서 — Combat Strafe의 범위, 금지사항, 요청할 자료.
3. `Docs/Animation/Locomotion/MotionMatching_StateController_Handoff_2026-08-01.md` — State Controller
   도입 배경 및 오래된 설계 결정. 현재 문서와 충돌하면 1번이 우선.
4. `Docs/Combat/CombatLocomotionArchitecture.md`, `Docs/Combat/CombatAnimationArchitectureNotes.md`
