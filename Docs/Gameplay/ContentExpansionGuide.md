...
직업·전직의 반복 DA 생성·연결은 에디터 **Tools → Project J → Create Class / Advancement Bundle**에서 시작할 수 있다. 기존 직업/스타일을 선택하고 미리보기 검증 후 미저장 에셋을 생성한다. 공격·애니메이션 등 공유 참조의 범위와 저장 후 runtime 등록 절차는 [제작 도구 가이드](../Architecture/Extensions/Content_Bundle_Authoring_2026-09-19.md)를 따른다.
