...
프로젝트 구조, 애니메이션, 네트워크 PIE 테스트를 정리하는 개발 문서 모음입니다.
...
- 에디터 애셋 데이터와 C++ 구조 변경 이유를 분리해서 기록합니다.
- 테스트 절차는 PIE에서 바로 따라 할 수 있는 형태로 유지합니다.
- 전투/무기처럼 아직 구현 전인 시스템은 확정 로직보다 책임 경계와 금지 방향 위주로 기록합니다.
